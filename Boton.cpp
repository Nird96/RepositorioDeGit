...

{
    ...
    ventana1 = CreateWindowEx (
           ...
           ("Tarde demasiado en entender esto :'v"),       /* Titulo de la ventana */
...
LRESULT CALLBACK WindowProcedure (HWND ventana1, UINT mensajecomunica, WPARAM wParam, LPARAM lParam)
{
...

    {
        ...
        case WM_CREATE:
            ...
            boton1 = CreateWindowEx(0, "button", ("Close"), WS_VISIBLE | WS_CHILD | 0x00000001, 282, 240, 80, 25, ventana1, (HMENU)ID1, GetModuleHandle(NULL), 0);
